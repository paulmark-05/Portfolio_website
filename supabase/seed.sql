-- ============================================================
-- seed.sql — initial content (matches src/lib/content.ts SEED)
-- Run AFTER 0001–0010 and AFTER creating your admin user.
-- Image paths point at /images/* static fallbacks; re-upload via the
-- CMS Media Library to move them into Supabase Storage.
-- ============================================================

insert into public.settings (id, email, linkedin, github, contact_image, seo_title, seo_desc, seo_keywords, sections)
values (1,
  'nayanipaul27@gmail.com',
  'https://www.linkedin.com/in/nayanipaul',
  'https://github.com/nayanipaul',
  '',
  'Nayani Paul — Software Engineer',
  ...
  array['full-stack developer','AI engineer','React','LangGraph','computer vision','accessibility','WCAG'],
  '[{"key":"work","visible":true},{"key":"stack","visible":true},{"key":"achievements","visible":false},{"key":"projects","visible":true},{"key":"certs","visible":true}]'::jsonb)
...
('West Bengal Sainik Board · Grievance & Visitor Management System','Full-Stack Developer','Jul 2025 — May 2026 · Kolkata','',
 'Built a full-stack grievance portal digitising workflows for 500+ personnel and cutting resolution time 60%, with backend routing and file-handling across 12 branches at 100% accuracy. Added a visitor management system with online appointment booking and an authenticated CMS admin panel — 100+ registrations in the first 24 hours.',
...
('medbot','MedBot — Agentic AI Healthcare Assistant',
 'Agentic RAG assistant built in LangGraph with a multi-node workflow (retrieval, tool use, self-evaluation) — <span class="m">90% task success</span>, <span class="m">0.84 faithfulness / 0.87 relevance</span> on RAGAS. Conversational memory + live web search to cut hallucination.',
...
('vision-assist','Vision Assistance for the Visually Impaired',
 'Real-time object detection (YOLOv8n) with threaded capture at <span class="m">25–30 FPS at 640x480 on CPU-only hardware</span>. Pinhole-geometry distance/direction estimation and a priority-based offline voice-alert engine for nearby hazards.',
...
('AI in Action — Job Simulation','Vista Equity Partners · Forage','Apr 2026','Completed Vista''s AI in Action job simulation: modelling AI use-cases, evaluation pipelines, and stakeholder framing.','/certificates/vista-ai.png',2),
...
('Prime Code Champ','TechGig.com','Jan 2025','Competitive programming recognition on TechGig''s Prime Code Champ challenge.','',4);

insert into public.achievements (title,description,icon,category,organization,year,link,highlight,visible,sort_order) values
('Letter of Commendation','Awarded by the Rajya Sainik Board for technical excellence and impact on public-service transparency.','★','Award','','','',true,true,0);
